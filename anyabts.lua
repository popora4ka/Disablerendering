...
function BindableButtons.AddBButton(id, text, onFunc, offFunc)
	...
	TextLabel.BackgroundTransparency, TextLabel.Font, TextLabel.Text = 1, Enum.Font.Jura, text
	...
	Aspect.AspectRatio, Aspect.AspectType = 1, Enum.AspectType.ScaleWithParentSize

	local Stroke = Instance.new("UIGradient", ImageButton)
	Stroke.Name, Stroke.Color = "@Stroke", __NORMAL_COLOR
